...
class ERFnetOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--teachers",
                                 help="teachers to use - order: name1 epoch1 trainset1 exp1 name2 epoch2 trainset2 exp2 ...",
                                 nargs='+')
        self.parser.add_argument("--lambda_GS",
                                 help="lambda GS of the distillation loss",
                                 type=int,
                                 default=1)
        self.parser.add_argument("--num_shot",
                                 help="",
                                 type=int,
                                 default=1)
        self.parser.add_argument("--num_exp",
                                 help="",
                                 type=int,
                                 default=20)
        self.parser.add_argument("--save_best_model",
                                 help="save_best_model",
                                 action="store_true")
        self.parser.add_argument("--load_best_model",
                                 help="load best teacher model",
                                 action="store_true")
        self.parser.add_argument("--pseudo_label_mode",
                                 help="pseudo_label_mode",
                                 action="store_true")
        self.parser.add_argument("--num_pseudo_labels",
                                 help="number of pseudo labels for each classes",
                                 type=int,
                                 default=10)
        self.parser.add_argument("--eval_base_model",
                                 help="eval_base_model",
                                 action="store_true")
        ...
        self.parser.add_argument("--mean_entropy",
                                 ...
                                 action="store_true")
        self.parser.add_argument("--multi_exp",
                                 help="",
                                 type=int,
                                 default=0)
        self.parser.add_argument("--save_evaluation_results",
                            help="save the class probabilities of every class-feature-map to disk",
                            action="store_true")
